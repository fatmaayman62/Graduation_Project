...
import imgProfile from "../../assets/avatar-3.jpg";
...
function Navbar({mode,changeMode}) { 
  ...
  return (
    <>
      {/* start navbar */}
      <nav className="bg-white dark:bg-[#1D293D] py-3 px-5 shadow-md fixed top-0 start-0 end-0 z-20">
        <div className="container mx-auto flex items-center justify-between">
          ...
          <div
            className={`md:flex absolute md:relative top-14 md:top-0 left-0 right-0 md:left-auto md:right-auto md:flex-row md:items-center md:gap-6 bg-white dark:bg-[#1D293D] md:bg-transparent py-4 px-5 md:p-0 shadow-lg md:shadow-none transition-all duration-300 ease-in-out ${
              isMobileMenuOpen 
          ...
          >
            ...
            <div className="Profile flex items-center mx-auto gap-4 md:gap-5">
              ...
              <span className="text-2xl cursor-pointer text-gray-700 dark:text-gray-300 p-1 hover:bg-gray-100 dark:hover:bg-[#c6c6c628] rounded relative transition-all duration-200 hover:scale-110">
              ...
              {/* Cart with animation */}
              <span
                className="text-2xl relative cursor-pointer text-gray-700 dark:text-gray-300 p-1 hover:bg-gray-100 dark:hover:bg-[#c6c6c628] rounded transition-all duration-200 hover:scale-110"
                onClick={() => { 
                  setOpenCart(true); 
                  setOpen(false);
      ...
      <div
        className={`
          fixed top-[64px] z-50 right-0 bottom-0 w-64 bg-[#F9FAFB] dark:bg-[#1D293D] shadow-lg
      ...
      >
        ...
        <div className="profile w-full mt-2 text-center mx-auto border-b border-main_border pt-1 pb-2">
          ...
          <div className="info_user">
            ...
            <Link to={'/user/profile'} className="bg-white border border-main_border dark:text-black text-[14px] my-2 px-3 py-1 rounded-[9px] hover:bg-gray-100 transition-colors inline-block">
              Edit Profile
            </Link>
          </div>
        </div>
        ...
        <ul className="space-y-1 border-b border-main_border">
          <li>
            <NavLink to={'/user/My_medicine'}>
              <button className="w-full flex items-center gap-3 px-4 py-2 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-[#c6c6c628] transition-colors">
                <svg
          ...
          <li>
            <NavLink to={'/user/prescription_scanner'}>
              <button className="w-full flex items-center gap-3 px-4 py-2 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-[#c6c6c628] transition-colors">
